...
## 2.24.0-beta.2 - 2023-02-10

### Fixed
- `QasFilters`: fixed value assignment for filters in value watcher.

## 2.24.0-beta.1 - 2023-02-09
### Fixed
- package-lock.json version on app-extension.

## 2.24.0-beta.0 - 2023-02-09
