...
## Unreleased
### Changed
- `QasSearchBox`: Changed watch `mx_search` to focus on search input after returning lazy loading data.

### Removed
- `QasSelect`: Removed attribute `bottomSlots` because it is not used.
