<template>
  <div class="col-12 container">
    <div class="q-mt-xl">
      ...
      <qas-uploader v-model="uploadDefault" v-model:uploading="isUploading" entity="service_orders/inspectionSignature" label="Image" />
    </div>

    <div class="q-mt-xl">
      <div>CustomUploader</div>
      <pre>model: {{ uploadDefault }}</pre>
      <qas-uploader v-model="uploadDefault" entity="service_orders/inspectionSignature">
        <template #custom-upload="{ context }">
          <qas-btn @click="context.dispatchUpload">Abrir fotos</qas-btn>
        </template>
      </qas-uploader>
    </div>
...
export default {
  data () {
    return {
      ...
      // QasCustomUploader 'https://s3.amazonaws.com/develop-portal-cms.bivilabs.com.br/uploads/portal-app/problems/photo/47751626-8e24-4e3f-8ac7-1aa837550336.png',
      uploadMultiple: [],
