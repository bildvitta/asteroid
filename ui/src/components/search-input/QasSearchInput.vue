<template>
  <div class="qas-filter-input">
    <qas-input ref="input" v-model="model" v-bind="$attrs" class="bg-white rounded-borders-sm" data-cy="search-input" :debounce="debounce" hide-bottom-space input-class="ellipsis text-grey-8" inputmode="search" outlined type="search">
      <template #prepend>
