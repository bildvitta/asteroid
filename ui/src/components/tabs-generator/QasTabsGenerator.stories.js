...
export default {
  ...
  parameters: {
    docs: { 
      description: { 
        component: 'Component to generate Tabs dynamically.'
        + '<br> This component implements QTabs e QTAb https://quasar.dev/vue-components/tabs#Introduction'
      } 
    }
  },
...
const Template = (args, { argTypes }) => ({
  ...
  template:
    `<qas-tabs-generator v-bind="$props" />`
})
...
const TemplateModifiedTabs = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  components: { QasTabsGenerator },
  template:`<div style="display: flex; justify-content: flex-end;"><b>View Code<b></div>`
})
